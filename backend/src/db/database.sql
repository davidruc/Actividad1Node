...
ALTER TABLE bodegas ADD CONSTRAINT id_responsable FOREIGN KEY (id_responsable) REFERENCES users(id), ADD CONSTRAINT created_by_bodegas FOREIGN KEY (created_by) REFERENCES users(id), ADD CONSTRAINT update_by_bodegas FOREIGN KEY (update_by) REFERENCES users(id);
ALTER TABLE historiales ADD CONSTRAINT id_bodega_origen FOREIGN KEY (id_bodega_origen) REFERENCES bodegas(id),ADD CONSTRAINT id_bodega_destino FOREIGN KEY (id_bodega_destino) REFERENCES bodegas(id),ADD CONSTRAINT created_by_historial FOREIGN KEY (created_by) REFERENCES users(id), ADD CONSTRAINT update_by_historial FOREIGN KEY (update_by) REFERENCES users(id), ADD CONSTRAINT id_inventario FOREIGN KEY (id_inventario) REFERENCES inventarios(id);
#INSERTAMOS DATOS DE PRUEBA A LA BD 
