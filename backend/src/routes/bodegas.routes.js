...
routerBodegas.get("/", proxyBodegas, (req, res)=>{
    ...
    bodegas.id_responsable AS "fk_responsable", 
    users.nombre AS "nombre_del_responsable", 
    bodegas.estado AS "Estado", 
    bodegas.created_by AS "creada_por", 
    bodegas.update_by AS "actualizada_por", 
    bodegas.created_at AS "creada_el", 
